...
var propTypes$1 = airbnbPropTypes.forbidExtraProps(_objectSpread$1({}, imagePropTypes, {
...
var propTypes$2 = airbnbPropTypes.forbidExtraProps(_objectSpread$2({}, imagePropTypes, {
  photo: PhotoShape,
...
function (_PureComponent) {
  ...
  createClass(Caption, [{
    ...
    value: function render() {
      ...
      }, React__default.createElement(TogglePhotoList, {
        phrases: phrases,
  ...
  createClass(PrevButton, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          disabled = _this$props.disabled,
          light = _this$props.light;
      return React__default.createElement(Control, {
  ...
  createClass(Gallery, [{
    ...
    value: function renderControls() {
      ...
      if (this.hasMoreThanOnePhoto) {
        // previous control
        if (!hidePrevButton) {
          controls.push(React__default.createElement(PrevButton, {
            key: ".prevControl",
        ...
        if (!hideNextButton) {
          controls.push(React__default.createElement(NextButton, {
            key: ".nextControl",
            disabled: controlsDisabled,
    ...
    value: function renderPreloadPhotos(current) {
      ...
      while (index < photos.length && counter <= preloadSize) {
        photo = photos[index];
        preloadPhotos.push(React__default.createElement("img", {
          key: photo.photo,
          alt: photo.photo,
          src: photo.photo
        }));
    ...
    value: function render() {
      ...
      if (this.hasPhotos) {
        ...
        }, React__default.createElement(Photo, {
          photo: current,
      ...
      }, content)), showThumbnails && current && React__default.createElement(Caption, {
        phrases: phrases,
...
var propTypes$b = airbnbPropTypes.forbidExtraProps(_objectSpread$7({}, galleryPropTypes, {
...
function (_Component) {
  ...
  function ReactBnbGallery(props) {
    ...
    _this.gallery = React__default.createRef();
  ...
  createClass(ReactBnbGallery, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(reactPortal.Portal, null, React__default.createElement(FocusTrap, null, React__default.createElement("div", {
