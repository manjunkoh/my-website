...
<div style={{height:'100%',background:'#fff',margin:'auto'}}>
  <Grid className="row">
    ...
    <div className="about-me">
      <h2>About Me</h2>
      <p> 
        Hey guys welcome to my (work in progress) website. My name is Man Jun. Thanks to my parents I just graduated from Virginia Tech with a degree in aerospace engineering; I also studied a good amount of computer engineering. Two things I can't live without are food and sports especially meat and baseball, but I also love learning and trying new things. My favorite music is Rock especially alternative and classic, but I generally enjoy most genres except country and heavy metal. I'm an extremely adventurous guy; top things on my bucket list are going to space, visiting North/South Pole, seeing an Aurora, and hiking in Patagonia. I am currently applying for a position in the Republic of Korea Air Force to complete my mandatory military service. Aerospace is something I have been deeply passionate about since day 1 and eventually I wanna use my skills to found an asteroid-mining company. Thanks for visiting!
